...
var provinceList = [{name: '请选择省份', cityList: [{name: '请选择城市', areaList: ['请选择区县']}]}, {
    name: '北京',
    cityList: [{
        name: '市辖区',
    ...
    cityList: [{
        name: '成都市',
        areaList: ['市辖区', '锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江县', '金堂县', '双流县', '郫　县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市','高新区']
...
}, {name: '台湾', cityList: []}, {name: '香港', cityList: []}, {name: '澳门', cityList: []}];