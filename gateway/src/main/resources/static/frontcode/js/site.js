...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope,$http,$location) {
        ...
        $http.get("../../auth/selectAllSite?start=0&limit=" + pageSize+"&access_token="+localStorage.getItem("access_token")).
		...
		$scope.delBs = function(id) {
			 ...
			 */
				...
				if (isConfirm) {
					$.ajax({
                        url : '../../auth/deleteSite?id='+id+"&access_token="+localStorage.getItem("access_token"),
                        type : 'get',
                        dataType : "json",
                        async : false,
		...
		$scope.search = function(page) {
			...
			$http.get("../../auth/selectAllSite?start=0&limit=" + limit+"&site_name="+site_name+"&site_industry="+site_industry+"&site_province="+site_province+"&site_city="+site_city+"&site_county="+site_county+"&status="+status+"&access_token="+localStorage.getItem("access_token")).
			success(function(response){
		...
		$scope.pageClick = function(page, totals, totalPages) {
			...
			$http.get("../../auth/selectAllSite?start="+start+"&limit=" + limit+"&site_name="+site_name+"&site_industry="+site_industry+"&site_province="+site_province+"&site_city="+site_city+"&site_county="+site_county+"&status="+status+"&access_token="+localStorage.getItem("access_token")).
			success(function(response){
				xh.maskHide();
...
xh.add = function() {
	...
	$.ajax({
		url : '../../auth/insertSite?access_token='+localStorage.getItem("access_token"),
...
xh.edit = function() {
    ...
    var str = JSON.stringify(f);
    $.ajax({
        url : '../../auth/updateSite?&access_token='+localStorage.getItem("access_token"),
        contentType : "application/json;charset=utf-8",
        type : 'GET',
        dataType : "json",
        async : true,
