...
public interface CatMapper {
    ...
    @Select("<script>" +
            "select a.*,b.cathode_state,b.alarm,count(b.cathode_state) num from cathode_config as a left join cathode_now_data as b on a.rtu_id=b.rtu_id and a.rtu_port=b.rtu_channel and a.cathode_id=b.cathode_id left join rtu_config c on a.rtu_id=c.rtu_id left join site_config d on c.site_id=d.site_id where d.site_company in " +
